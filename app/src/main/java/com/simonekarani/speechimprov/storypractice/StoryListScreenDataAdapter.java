...
public class StoryListScreenDataAdapter extends RecyclerView.Adapter<StoryListScreenDataAdapter.MyViewHolder> {

    private static final String TAG = "WordPracticeListActivity";
    ...
    public StoryListScreenDataAdapter(ArrayList<MainScreenDataModel> data, OnMoralTopicListener listener) {
        this.dataSet = data;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(StoryPracticeListActivity.myOnClickListener);
